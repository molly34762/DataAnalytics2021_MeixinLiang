...
post(fitK, file = â???okyphosistree.ps", title = "Classification Tree for Kyphosis") # might need to convert to PDF (distill)
...
post(pfitK, file = â???optree.ps", title = "Pruned Classification Tree for Kyphosisâ???)